...
<html>
  <head>
    ...
    <meta charset="UTF-8">
    <link rel="icon" href="http://aasksoft.com/images/hlogo.png"/>
...
var markerTitles=[];
   ...
   //alert(markers.length);
      ...
      function initialize() {
        ...
        // set map options .SATELLITE .ROADMAP
        var myOptions = {
          zoom: 13,
          //minZoom: 10,
    ...
    <div class="topbar" id="topbar">
      <div class="wrapper">
        ...
        <div class="left">
            ...
            <a href="./">
                <img src="http://aasksoft.com/images/logo2.png" alt="@aasksoft" width="200px" height="80px;" />
            </a>
          </div>
          <div class="buttons">
    ...
    <div class="modal hide" id="modal_info">
      ...
      <div class="modal-body">
        <p>
          ...
          in our beloved @asksoft. We've seeded the map but we need
          ...
          <?php } ?>
          Let's put Location on the map together!
        </p>
       <img src="http://aasksoft.com/images/logo2.png" alt="@aasksoft" width="200px" height="80px;" />
        ...
        <div class="modal-body">
          ...
          <ul>
            <li>
              ...
              <div>
                Our map pulls its data from <a href="http://www.aasksoft.com">@asksoft</a>.
