...
if($page != "login") {
  if($_COOKIE["aasksoftmap_user"] != crypt($admin_user, $admin_user) OR $_COOKIE["aasksoftmap_pass"] != crypt($admin_pass, $admin_pass)) {
...
if($sg_enabled) {
  $admin_head .= "
    <div class='alert alert-info'>
      ...
      <a href='http://www.aasksoft.comc'>Startup Genome website</a>. Any changes
