...
if($mysqli_object->query("update rstock set qty=qty+'".removeNoice('qty')."' where barcode='".removeNoice('barcode')."' and shopemail='$email'")==true && $mysqli_object->query("DELETE FROM `rkart` WHERE shopemail='$email' and barcode='".removeNoice('barcode')."'"))
{
    ?>
