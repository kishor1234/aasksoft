...
?> 
            ...
            <div id="logo">
              ...
              <img id="image" src="<?php echo $shoplogo;?>" alt="logo" />
            </div>
		...
		<table  id="items">
		  ...
		  <tr>
		      ...
		      <td><textarea class="cost"><?php echo $row['rate'];?>₹</textarea></td>
		      <td><textarea class="qty"><?php echo $row['qty'];?></textarea></td>
		      <td><textarea class="price"><?php echo $row['totalprice'];?>₹</textarea></td>
		  </tr>
		  <?php
                       $i++;
                        } 
		  ...
		  <tr>
		      ...
		      <td class="total-value"><div id="total"><strong><?php echo $vat;?>&nbsp;₹</strong></div></td>
		  </tr>
		  <tr>
		      <td colspan="2" class="blank"> </td>
